...
Date        : 2025-01-16 17:11:21
Last Edited : 2025-01-17 11:32:14
Last Author : Jie Li
File Path   : /BIGPAST/Python/sim_3_2_mixed_less_transformation.py
Description :
...
for j, (n, t_th) in enumerate(zip(n_all, t_critical)):
    ...
    results_all[j, :, 0] = [fpr_cg_less, tpr_cg_less, acc_cg_less]
